...
* [Label tool](https://github.com/Slava/label-tool) - MIT license. Online [demo](http://slv.io/label-tool/demo/) without savings.
* [Django Labeller](https://github.com/Britefury/django-labeller) - MIT license. A light-weight image labelling tool for Python designed for creating segmentation data sets.
...
Maybe in the near future I'll try [Groundwork](https://groundwork.azavea.com), an online [free](https://groundwork.azavea.com/pricing) image labeling tool for creating custom training datasets from **satellite** imagery. It requires WebGL 2.0. Maps are loading quite slowly.
