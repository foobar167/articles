...
- capsule network
- Andrew Ng
- [active learning](https://youtu.be/ANIw1Mz1SRI)
...
* [33:00](https://youtu.be/J6XcP4JOHmk?t=1980) One of the research areas now is **doing more with less data**: [transfer learning](https://jovian.ai/aakashns/transfer-learning-pytorch), [active learning](https://youtu.be/ANIw1Mz1SRI) ([41:49](https://youtu.be/J6XcP4JOHmk?t=2509)), ect.
...
Do more with less data, preferably with unsupervised of semi-unsupervised learning. Use Machine Learning in your expert domain area and solve everyday life practical problems with this tool. Keep learning even if you don't understand something, because the key difference between people that succeed and people that fail is tenacity.
